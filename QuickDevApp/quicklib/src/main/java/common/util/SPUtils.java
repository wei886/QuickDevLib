...
public class SPUtils {
    ...
    public static boolean put(String fileName, String key, Object obj) {
        ...
        SharedPreferences.Editor editor = BaseApplication.mContext.getSharedPreferences(fileName,
    ...
    public static Object get(String fileName, String key, Object defaultObj) {
        ...
        SharedPreferences sp = BaseApplication.mContext.getSharedPreferences(fileName, Context
                .MODE_PRIVATE);
    ...
    public static void remove(String... keys) {
        SharedPreferences sp = BaseApplication.mContext.getSharedPreferences(DEFAULT_NAME,
